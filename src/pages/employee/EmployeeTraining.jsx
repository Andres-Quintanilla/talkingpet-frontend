...
const EMPTY_FORM = {
  id: null,
  tipo: 'video', // video | curso_presencial
  titulo: '',
  descripcion: '',
  url_video: '',
  fecha: '',
      ...
      <header className="admin-main__header admin-header">
        <div>
          ...
          <p className="admin-main__subtitle">
            Gestiona videos y cursos presenciales de adiestramiento. Puedes
            crear nuevos y activarlos o desactivarlos.
          </p>
        </div>
      </header>
