...
export default function EmployeeServices() {
  ...
  const loadServices = async () => {
    ...
    try {
      ...
      console.error('Error cargando servicios empleado', e);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error('Error guardando servicio (empleado)', e);
      const msgServer =
      ...
      <header className="admin-main__header admin-header">
        <div>
          ...
          <p className="admin-main__subtitle">
            Como empleado puedes crear y editar servicios. La eliminación solo la realiza un administrador.
          </p>
        </div>
                  ...
                  <tr key={s.id}>
                    ...
                    <td>
                      <div className="actions">
                        ...
                        {/* Sin botón de eliminar para empleados */}
                      </div>
                    </td>
                  </tr>
                ))
