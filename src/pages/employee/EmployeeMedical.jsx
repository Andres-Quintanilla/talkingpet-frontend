      ...
      <header className="admin-main__header admin-header">
        <div>
          ...
          <p className="admin-main__subtitle">
            Edita información clínica de las mascotas con citas médicas:
            peso, castración, vacunas y próximas aplicaciones.
          </p>
        </div>
      </header>
                  ...
                  <div className="form-row">
                    <div className="form-group">
                      ...
                      <textarea
                        ...
                        className="form-input"
                        rows={3}
                        placeholder="Ej: Rabia (2024-01-10), Séxtuple (2024-02-15)..."
                        value={form.vacunas}
                        onChange={handleChange}
                      />
                    </div>
